...
<div class="row projects">
    <div class="medium-12 large-centered column view-box">
        ...
        <!-- <div class="proj-func">
            <a href="{{URL::to('secretary/projects/' . $project->id . '/edit')}}" class="small button proj-func-button"><i class="fa fa-pencil"></i>Edit</a>
        ...
        <div class="project-collab-container table-title">
            <!-- <div class="proj-btn-container right">
                <a href="{{URL::to('secretary/projects/add/users/' . $project->id)}}" class="small button create-quot"><i class="fa fa-plus"></i>Add New Collaborator</a>
            </div> -->
            <table> 
                  <thead>
                  <tr>
                  ...
                  @if(!is_null($users))
                    @foreach($users as $user)
                      <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td>
                          <a href="{{URL::to('/secretary/project/' . $project->id . '/user/' . $user->id . '/delete')}}">Remove</a>
                        </td>
                      </tr>
                    @endforeach
                  @endif
